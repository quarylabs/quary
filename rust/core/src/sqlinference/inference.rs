...
use super::infer_tests::{InferenceReason, infer_tests};
use super::test::Test;
...
mod tests {
    ...
    use super::*;
    use super::super::inference::TestRunnerAction::{Run, Skip};
    use super::super::test::{AcceptedValuesTest, ComparisonTest, StandardTest};
