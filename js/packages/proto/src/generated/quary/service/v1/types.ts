...
export const Test: MessageFns<Test> = {
  encode(message: Test, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    switch (message.testType?.$case) {
      case "sql":
        TestSQLFile.encode(message.testType.sql, writer.uint32(10).fork()).join();
        break;
      case "unique":
        TestUnique.encode(message.testType.unique, writer.uint32(18).fork()).join();
        break;
      case "notNull":
        TestNotNull.encode(message.testType.notNull, writer.uint32(26).fork()).join();
        break;
      case "relationship":
        TestRelationship.encode(message.testType.relationship, writer.uint32(34).fork()).join();
        break;
      case "acceptedValues":
        TestAcceptedValues.encode(message.testType.acceptedValues, writer.uint32(42).fork()).join();
        break;
      case "greaterThanOrEqual":
        TestGreaterThanOrEqual.encode(message.testType.greaterThanOrEqual, writer.uint32(50).fork()).join();
        break;
      case "lessThanOrEqual":
        TestLessThanOrEqual.encode(message.testType.lessThanOrEqual, writer.uint32(58).fork()).join();
        break;
      case "greaterThan":
        TestGreaterThan.encode(message.testType.greaterThan, writer.uint32(66).fork()).join();
        break;
      case "lessThan":
        TestLessThan.encode(message.testType.lessThan, writer.uint32(74).fork()).join();
        break;
      case "multiColumnUnique":
        TestMultiColumnUnique.encode(message.testType.multiColumnUnique, writer.uint32(82).fork()).join();
        break;
    }
    return writer;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Test>, I>>(object: I): Test {
    const message = createBaseTest();
    switch (object.testType?.$case) {
      case "sql": {
        if (object.testType?.sql !== undefined && object.testType?.sql !== null) {
          message.testType = { $case: "sql", sql: TestSQLFile.fromPartial(object.testType.sql) };
        }
        break;
      }
      case "unique": {
        if (object.testType?.unique !== undefined && object.testType?.unique !== null) {
          message.testType = { $case: "unique", unique: TestUnique.fromPartial(object.testType.unique) };
        }
        break;
      }
      case "notNull": {
        if (object.testType?.notNull !== undefined && object.testType?.notNull !== null) {
          message.testType = { $case: "notNull", notNull: TestNotNull.fromPartial(object.testType.notNull) };
        }
        break;
      }
      case "relationship": {
        if (object.testType?.relationship !== undefined && object.testType?.relationship !== null) {
          message.testType = {
            $case: "relationship",
      ...
      case "acceptedValues": {
        if (object.testType?.acceptedValues !== undefined && object.testType?.acceptedValues !== null) {
          message.testType = {
            $case: "acceptedValues",
      ...
      case "greaterThanOrEqual": {
        if (object.testType?.greaterThanOrEqual !== undefined && object.testType?.greaterThanOrEqual !== null) {
          message.testType = {
            $case: "greaterThanOrEqual",
      ...
      case "lessThanOrEqual": {
        if (object.testType?.lessThanOrEqual !== undefined && object.testType?.lessThanOrEqual !== null) {
          message.testType = {
            $case: "lessThanOrEqual",
      ...
      case "greaterThan": {
        if (object.testType?.greaterThan !== undefined && object.testType?.greaterThan !== null) {
          message.testType = {
            $case: "greaterThan",
      ...
      case "lessThan": {
        if (object.testType?.lessThan !== undefined && object.testType?.lessThan !== null) {
          message.testType = { $case: "lessThan", lessThan: TestLessThan.fromPartial(object.testType.lessThan) };
        }
        break;
      }
      case "multiColumnUnique": {
        if (object.testType?.multiColumnUnique !== undefined && object.testType?.multiColumnUnique !== null) {
          message.testType = {
            $case: "multiColumnUnique",
...
export const TestSQLFile: MessageFns<TestSQLFile> = {
  encode(message: TestSQLFile, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.filePath !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TestSQLFile {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const TestUnique: MessageFns<TestUnique> = {
  encode(message: TestUnique, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.filePath !== "") {
      writer.uint32(10).string(message.filePath);
    }
    if (message.model !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TestUnique {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const TestNotNull: MessageFns<TestNotNull> = {
  encode(message: TestNotNull, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.filePath !== "") {
      writer.uint32(10).string(message.filePath);
    }
    if (message.model !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TestNotNull {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const TestGreaterThanOrEqual: MessageFns<TestGreaterThanOrEqual> = {
  encode(message: TestGreaterThanOrEqual, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.filePath !== "") {
      writer.uint32(10).string(message.filePath);
    }
    if (message.model !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TestGreaterThanOrEqual {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const TestLessThanOrEqual: MessageFns<TestLessThanOrEqual> = {
  encode(message: TestLessThanOrEqual, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.filePath !== "") {
      writer.uint32(10).string(message.filePath);
    }
    if (message.model !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TestLessThanOrEqual {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const TestGreaterThan: MessageFns<TestGreaterThan> = {
  encode(message: TestGreaterThan, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.filePath !== "") {
      writer.uint32(10).string(message.filePath);
    }
    if (message.model !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TestGreaterThan {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const TestLessThan: MessageFns<TestLessThan> = {
  encode(message: TestLessThan, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.filePath !== "") {
      writer.uint32(10).string(message.filePath);
    }
    if (message.model !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TestLessThan {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const TestRelationship: MessageFns<TestRelationship> = {
  encode(message: TestRelationship, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.filePath !== "") {
      writer.uint32(10).string(message.filePath);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TestRelationship {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const TestAcceptedValues: MessageFns<TestAcceptedValues> = {
  encode(message: TestAcceptedValues, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.filePath !== "") {
      writer.uint32(10).string(message.filePath);
    }
    if (message.model !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TestAcceptedValues {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const TestMultiColumnUnique: MessageFns<TestMultiColumnUnique> = {
  encode(message: TestMultiColumnUnique, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.filePath !== "") {
      writer.uint32(10).string(message.filePath);
    }
    if (message.model !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TestMultiColumnUnique {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Model: MessageFns<Model> = {
  encode(message: Model, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.columns) {
      Model_ModelColum.encode(v!, writer.uint32(42).fork()).join();
    }
    for (const v of message.references) {
      writer.uint32(50).string(v!);
    }
    if (message.databaseConfig !== undefined) {
      Struct.encode(Struct.wrap(message.databaseConfig), writer.uint32(74).fork()).join();
    }
    return writer;
  },
...
export const Model_ModelColum: MessageFns<Model_ModelColum> = {
  encode(message: Model_ModelColum, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Model_ModelColum {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Snapshot: MessageFns<Snapshot> = {
  encode(message: Snapshot, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.strategy !== undefined) {
      Snapshot_SnapshotStrategy.encode(message.strategy, writer.uint32(50).fork()).join();
    }
    for (const v of message.references) {
...
export const Snapshot_SnapshotStrategy: MessageFns<Snapshot_SnapshotStrategy> = {
  encode(message: Snapshot_SnapshotStrategy, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Snapshot_SnapshotStrategy {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<Snapshot_SnapshotStrategy>, I>>(object: I): Snapshot_SnapshotStrategy {
    const message = createBaseSnapshot_SnapshotStrategy();
    switch (object.strategyType?.$case) {
      case "timestamp": {
        if (object.strategyType?.timestamp !== undefined && object.strategyType?.timestamp !== null) {
          message.strategyType = {
            $case: "timestamp",
...
export const Snapshot_SnapshotStrategy_TimestampStrategy: MessageFns<Snapshot_SnapshotStrategy_TimestampStrategy> = {
  encode(
    message: Snapshot_SnapshotStrategy_TimestampStrategy,
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Snapshot_SnapshotStrategy_TimestampStrategy {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Source: MessageFns<Source> = {
  encode(message: Source, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.columns) {
      Source_SourceColumn.encode(v!, writer.uint32(42).fork()).join();
    }
    return writer;
  },
...
export const Source_SourceColumn: MessageFns<Source_SourceColumn> = {
  encode(message: Source_SourceColumn, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Source_SourceColumn {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
