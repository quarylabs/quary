...
export const DashboardFile: MessageFns<DashboardFile> = {
  encode(message: DashboardFile, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.items) {
      DashboardItem.encode(v!, writer.uint32(42).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DashboardFile {
...
export const DashboardItem: MessageFns<DashboardItem> = {
  encode(message: DashboardItem, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    switch (message.item?.$case) {
      case "chart":
        DashboardChart.encode(message.item.chart, writer.uint32(42).fork()).join();
        break;
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DashboardItem {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<DashboardItem>, I>>(object: I): DashboardItem {
    ...
    switch (object.item?.$case) {
      case "chart": {
        if (object.item?.chart !== undefined && object.item?.chart !== null) {
...
export const DashboardChart: MessageFns<DashboardChart> = {
  encode(message: DashboardChart, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    switch (message.chart?.$case) {
      case "reference":
        DashboardChartReference.encode(message.chart.reference, writer.uint32(10).fork()).join();
        break;
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DashboardChart {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<DashboardChart>, I>>(object: I): DashboardChart {
    const message = createBaseDashboardChart();
    switch (object.chart?.$case) {
      case "reference": {
        if (object.chart?.reference !== undefined && object.chart?.reference !== null) {
          message.chart = {
            $case: "reference",
            reference: DashboardChartReference.fromPartial(object.chart.reference),
          };
        }
        break;
      }
...
export const DashboardChartReference: MessageFns<DashboardChartReference> = {
  encode(message: DashboardChartReference, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DashboardChartReference {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
