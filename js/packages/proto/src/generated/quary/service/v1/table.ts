...
export const Table: MessageFns<Table> = {
  encode(message: Table, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    switch (message.tableType?.$case) {
      case "present":
        Table_PresentInSchema.encode(message.tableType.present, writer.uint32(10).fork()).join();
        break;
      case "notPresent":
        Table_NotPresentInSchema.encode(message.tableType.notPresent, writer.uint32(18).fork()).join();
        break;
    }
    return writer;
  },
  ...
  toJSON(message: Table): unknown {
    ...
    } else if (message.tableType?.$case === "notPresent") {
  ...
  fromPartial<I extends Exact<DeepPartial<Table>, I>>(object: I): Table {
    const message = createBaseTable();
    switch (object.tableType?.$case) {
      case "present": {
        if (object.tableType?.present !== undefined && object.tableType?.present !== null) {
          message.tableType = {
            $case: "present",
            present: Table_PresentInSchema.fromPartial(object.tableType.present),
          };
        }
        break;
      }
      case "notPresent": {
        if (object.tableType?.notPresent !== undefined && object.tableType?.notPresent !== null) {
          message.tableType = {
            $case: "notPresent",
...
export const Table_PresentInSchema: MessageFns<Table_PresentInSchema> = {
  encode(message: Table_PresentInSchema, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.rows) {
      Table_PresentInSchema_PresentRow.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Table_PresentInSchema {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Table_PresentInSchema_PresentRow: MessageFns<Table_PresentInSchema_PresentRow> = {
  encode(message: Table_PresentInSchema_PresentRow, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    switch (message.row?.$case) {
      case "presentInSqlAndDefinitions":
        Row.encode(message.row.presentInSqlAndDefinitions, writer.uint32(10).fork()).join();
        break;
      case "missingInDefinitions":
        Row.encode(message.row.missingInDefinitions, writer.uint32(18).fork()).join();
        break;
      case "presentInDefinitionsButNotRecognisableInSql":
        Row.encode(message.row.presentInDefinitionsButNotRecognisableInSql, writer.uint32(26).fork()).join();
        break;
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Table_PresentInSchema_PresentRow {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: Table_PresentInSchema_PresentRow): unknown {
    ...
    } else if (message.row?.$case === "missingInDefinitions") {
      obj.missingInDefinitions = Row.toJSON(message.row.missingInDefinitions);
    } else if (message.row?.$case === "presentInDefinitionsButNotRecognisableInSql") {
  ...
  fromPartial<I extends Exact<DeepPartial<Table_PresentInSchema_PresentRow>, I>>(
    ...
    const message = createBaseTable_PresentInSchema_PresentRow();
    switch (object.row?.$case) {
      case "presentInSqlAndDefinitions": {
        if (object.row?.presentInSqlAndDefinitions !== undefined && object.row?.presentInSqlAndDefinitions !== null) {
          message.row = {
            $case: "presentInSqlAndDefinitions",
      ...
      case "missingInDefinitions": {
        if (object.row?.missingInDefinitions !== undefined && object.row?.missingInDefinitions !== null) {
          message.row = {
            $case: "missingInDefinitions",
...
export const Table_NotPresentInSchema: MessageFns<Table_NotPresentInSchema> = {
  encode(message: Table_NotPresentInSchema, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.rows) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Table_NotPresentInSchema {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Row: MessageFns<Row> = {
  encode(message: Row, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.tests) {
      RowTest.encode(v!, writer.uint32(18).fork()).join();
    }
    if (message.description !== undefined) {
      RowDescription.encode(message.description, writer.uint32(26).fork()).join();
    }
    return writer;
  },
...
export const RowTest: MessageFns<RowTest> = {
  encode(message: RowTest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    switch (message.test?.$case) {
      case "presentAndNotInferred":
        RowTestDetails.encode(message.test.presentAndNotInferred, writer.uint32(10).fork()).join();
        break;
      case "presentAndInferred":
        RowTestDetails.encode(message.test.presentAndInferred, writer.uint32(18).fork()).join();
        break;
      case "notPresentButInferred":
        RowTestDetails.encode(message.test.notPresentButInferred, writer.uint32(26).fork()).join();
        break;
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RowTest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: RowTest): unknown {
    ...
    } else if (message.test?.$case === "presentAndInferred") {
      obj.presentAndInferred = RowTestDetails.toJSON(message.test.presentAndInferred);
    } else if (message.test?.$case === "notPresentButInferred") {
  ...
  fromPartial<I extends Exact<DeepPartial<RowTest>, I>>(object: I): RowTest {
    const message = createBaseRowTest();
    switch (object.test?.$case) {
      case "presentAndNotInferred": {
        if (object.test?.presentAndNotInferred !== undefined && object.test?.presentAndNotInferred !== null) {
          message.test = {
            $case: "presentAndNotInferred",
      ...
      case "presentAndInferred": {
        if (object.test?.presentAndInferred !== undefined && object.test?.presentAndInferred !== null) {
          message.test = {
            $case: "presentAndInferred",
      ...
      case "notPresentButInferred": {
        if (object.test?.notPresentButInferred !== undefined && object.test?.notPresentButInferred !== null) {
          message.test = {
            $case: "notPresentButInferred",
...
export const RowTestDetails: MessageFns<RowTestDetails> = {
  encode(message: RowTestDetails, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.text !== "") {
      writer.uint32(10).string(message.text);
    }
    if (message.columnTest !== undefined) {
      ColumnTest.encode(message.columnTest, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RowTestDetails {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RowDescription: MessageFns<RowDescription> = {
  encode(message: RowDescription, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    switch (message.description?.$case) {
      ...
      case "inferred":
        ...
        break;
      case "notPresent":
        Empty.encode(message.description.notPresent, writer.uint32(42).fork()).join();
        break;
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RowDescription {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: RowDescription): unknown {
    ...
    } else if (message.description?.$case === "presentAndInferredIdentical") {
      obj.presentAndInferredIdentical = message.description.presentAndInferredIdentical;
    } else if (message.description?.$case === "presentWithDifferentInference") {
      obj.presentWithDifferentInference = RowDescription_PresentWithInference.toJSON(
        message.description.presentWithDifferentInference,
      );
    } else if (message.description?.$case === "inferred") {
      obj.inferred = message.description.inferred;
    } else if (message.description?.$case === "notPresent") {
  ...
  fromPartial<I extends Exact<DeepPartial<RowDescription>, I>>(object: I): RowDescription {
    const message = createBaseRowDescription();
    switch (object.description?.$case) {
      case "present": {
        if (object.description?.present !== undefined && object.description?.present !== null) {
      ...
      case "inferred": {
        if (object.description?.inferred !== undefined && object.description?.inferred !== null) {
          message.description = { $case: "inferred", inferred: object.description.inferred };
        }
        break;
      }
      case "notPresent": {
        if (object.description?.notPresent !== undefined && object.description?.notPresent !== null) {
...
export const RowDescription_PresentWithInference: MessageFns<RowDescription_PresentWithInference> = {
  encode(message: RowDescription_PresentWithInference, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.present !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RowDescription_PresentWithInference {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
