...
export const ListTablesRequest: MessageFns<ListTablesRequest> = {
  encode(_: ListTablesRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const ListTablesResponse: MessageFns<ListTablesResponse> = {
  encode(message: ListTablesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.tables) {
      TableAddress.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },
...
export const ExecResponse: MessageFns<ExecResponse> = {
  encode(_: ExecResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const QueryResponse: MessageFns<QueryResponse> = {
  encode(message: QueryResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.result !== undefined) {
      QueryResult.encode(message.result, writer.uint32(10).fork()).join();
    }
    return writer;
  },
...
export const ListColumnsRequest: MessageFns<ListColumnsRequest> = {
  encode(message: ListColumnsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListColumnsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListColumnsResponse: MessageFns<ListColumnsResponse> = {
  encode(message: ListColumnsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListColumnsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListSourcesRequest: MessageFns<ListSourcesRequest> = {
  encode(_: ListSourcesRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export class CLIRPCServiceClientImpl implements CLIRPCService {
  ...
  ListTables(request: ListTablesRequest): Promise<ListTablesResponse> {
    ...
    return promise.then((data) => ListTablesResponse.decode(new BinaryReader(data)));
  }

  ListViews(request: ListViewsRequest): Promise<ListViewsResponse> {
    const data = ListViewsRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ListViews", data);
    return promise.then((data) => ListViewsResponse.decode(new BinaryReader(data)));
  }

  Exec(request: ExecRequest): Promise<ExecResponse> {
    const data = ExecRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "Exec", data);
    return promise.then((data) => ExecResponse.decode(new BinaryReader(data)));
  }
  ...
  ListColumns(request: ListColumnsRequest): Promise<ListColumnsResponse> {
    ...
    return promise.then((data) => ListColumnsResponse.decode(new BinaryReader(data)));
  }

  ListSources(request: ListSourcesRequest): Promise<ListSourcesResponse> {
    const data = ListSourcesRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ListSources", data);
    return promise.then((data) => ListSourcesResponse.decode(new BinaryReader(data)));
  }
}
