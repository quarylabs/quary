...
export const ProjectDag: MessageFns<ProjectDag> = {
  encode(message: ProjectDag, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ProjectDag {
