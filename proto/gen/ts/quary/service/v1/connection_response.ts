...
export const BigQueryProjectReference: MessageFns<BigQueryProjectReference> = {
  encode(message: BigQueryProjectReference, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BigQueryProjectReference {
...
export const BigQueryProject: MessageFns<BigQueryProject> = {
  encode(message: BigQueryProject, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.kind !== "") {
    ...
    if (message.projectReference !== undefined) {
      BigQueryProjectReference.encode(message.projectReference, writer.uint32(34).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BigQueryProject {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BigQueryDatasetReference: MessageFns<BigQueryDatasetReference> = {
  encode(message: BigQueryDatasetReference, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectId !== "") {
      writer.uint32(10).string(message.projectId);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BigQueryDatasetReference {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BigQueryDataset: MessageFns<BigQueryDataset> = {
  encode(message: BigQueryDataset, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.datasetReference !== undefined) {
      BigQueryDatasetReference.encode(message.datasetReference, writer.uint32(26).fork()).join();
    }
    if (message.friendlyName !== "") {
      writer.uint32(34).string(message.friendlyName);
    }
    Object.entries(message.labels).forEach(([key, value]) => {
      BigQueryDataset_LabelsEntry.encode({ key: key as any, value }, writer.uint32(42).fork()).join();
    });
    if (message.location !== "") {
...
export const BigQueryDataset_LabelsEntry: MessageFns<BigQueryDataset_LabelsEntry> = {
  encode(message: BigQueryDataset_LabelsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BigQueryDataset_LabelsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BigQueryTableReference: MessageFns<BigQueryTableReference> = {
  encode(message: BigQueryTableReference, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectId !== "") {
      writer.uint32(10).string(message.projectId);
    }
    if (message.datasetId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BigQueryTableReference {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BigQueryTable: MessageFns<BigQueryTable> = {
  encode(message: BigQueryTable, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.tableReference !== undefined) {
      BigQueryTableReference.encode(message.tableReference, writer.uint32(26).fork()).join();
    }
    if (message.type !== "") {
...
export const BigQueryTableField: MessageFns<BigQueryTableField> = {
  encode(message: BigQueryTableField, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
    ...
    for (const v of message.fields) {
      BigQueryTableField.encode(v!, writer.uint32(34).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BigQueryTableField {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BigQueryTableSchema: MessageFns<BigQueryTableSchema> = {
  encode(message: BigQueryTableSchema, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    if (message.type !== "") {
    ...
    for (const v of message.fields) {
      BigQueryTableField.encode(v!, writer.uint32(26).fork()).join();
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BigQueryTableSchema {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BigQueryJobReference: MessageFns<BigQueryJobReference> = {
  encode(message: BigQueryJobReference, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectId !== "") {
      writer.uint32(10).string(message.projectId);
    }
    if (message.jobId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BigQueryJobReference {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BigQueryError: MessageFns<BigQueryError> = {
  encode(message: BigQueryError, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.reason !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BigQueryError {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BigQueryJobStatus: MessageFns<BigQueryJobStatus> = {
  encode(message: BigQueryJobStatus, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.state !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BigQueryJobStatus {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BigQueryJob: MessageFns<BigQueryJob> = {
  encode(message: BigQueryJob, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.jobReference !== undefined) {
      BigQueryJobReference.encode(message.jobReference, writer.uint32(42).fork()).join();
    }
    if (message.status !== undefined) {
      BigQueryJobStatus.encode(message.status, writer.uint32(50).fork()).join();
    }
    return writer;
  },
...
export const BigQueryFieldValue: MessageFns<BigQueryFieldValue> = {
  encode(message: BigQueryFieldValue, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.f !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BigQueryFieldValue {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BigQueryTableRow: MessageFns<BigQueryTableRow> = {
  encode(message: BigQueryTableRow, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.f) {
      BigQueryFieldValue.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): BigQueryTableRow {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BigQueryJobResults: MessageFns<BigQueryJobResults> = {
  encode(message: BigQueryJobResults, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.kind !== "") {
      writer.uint32(10).string(message.kind);
    }
    if (message.schema !== undefined) {
      BigQueryTableSchema.encode(message.schema, writer.uint32(18).fork()).join();
    }
    if (message.jobReference !== undefined) {
      BigQueryJobReference.encode(message.jobReference, writer.uint32(26).fork()).join();
    }
    ...
    for (const v of message.rows) {
      BigQueryTableRow.encode(v!, writer.uint32(50).fork()).join();
    }
    if (message.jobComplete !== "") {
      writer.uint32(58).string(message.jobComplete);
    }
    for (const v of message.errors) {
      BigQueryError.encode(v!, writer.uint32(66).fork()).join();
    }
    if (message.cacheHit !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BigQueryJobResults {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BigQueryOauthToken: MessageFns<BigQueryOauthToken> = {
  encode(message: BigQueryOauthToken, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BigQueryOauthToken {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BigQueryOauthTokenRefresh: MessageFns<BigQueryOauthTokenRefresh> = {
  encode(message: BigQueryOauthTokenRefresh, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.accessToken !== "") {
      writer.uint32(10).string(message.accessToken);
    }
    if (message.expiryTime !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BigQueryOauthTokenRefresh {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SnowflakeOauthProxyRequest: MessageFns<SnowflakeOauthProxyRequest> = {
  encode(message: SnowflakeOauthProxyRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SnowflakeOauthProxyRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SnowflakeOauthToken: MessageFns<SnowflakeOauthToken> = {
  encode(message: SnowflakeOauthToken, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.accessToken !== "") {
      writer.uint32(10).string(message.accessToken);
    }
    if (message.refreshToken !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SnowflakeOauthToken {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SnowflakeOauthRefreshToken: MessageFns<SnowflakeOauthRefreshToken> = {
  encode(message: SnowflakeOauthRefreshToken, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.accessToken !== "") {
      writer.uint32(10).string(message.accessToken);
    }
    if (message.expiryTime !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SnowflakeOauthRefreshToken {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
