...
export const ProjectFile: MessageFns<ProjectFile> = {
  encode(message: ProjectFile, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.sources) {
      ProjectFileSource.encode(v!, writer.uint32(10).fork()).join();
    }
    for (const v of message.models) {
      ProjectFile_Model.encode(v!, writer.uint32(18).fork()).join();
    }
    for (const v of message.snapshots) {
      ProjectFile_Snapshot.encode(v!, writer.uint32(26).fork()).join();
    }
    return writer;
  },
...
export const ProjectFile_Model: MessageFns<ProjectFile_Model> = {
  encode(message: ProjectFile_Model, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
    ...
    for (const v of message.tests) {
      ModelTest.encode(v!, writer.uint32(42).fork()).join();
    }
    if (message.databaseConfig !== undefined) {
      Struct.encode(Struct.wrap(message.databaseConfig), writer.uint32(58).fork()).join();
    }
    for (const v of message.columns) {
      ProjectFileColumn.encode(v!, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ProjectFile_Model {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ProjectFile_Snapshot: MessageFns<ProjectFile_Snapshot> = {
  encode(message: ProjectFile_Snapshot, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    for (const v of message.tags) {
    ...
    if (message.strategy !== undefined) {
      ProjectFile_SnapshotStrategy.encode(message.strategy, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ProjectFile_Snapshot {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ProjectFile_SnapshotStrategy: MessageFns<ProjectFile_SnapshotStrategy> = {
  encode(message: ProjectFile_SnapshotStrategy, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    switch (message.strategyType?.$case) {
      case "timestamp":
        ProjectFile_TimestampStrategy.encode(message.strategyType.timestamp, writer.uint32(10).fork()).join();
        break;
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ProjectFile_SnapshotStrategy {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ProjectFile_TimestampStrategy: MessageFns<ProjectFile_TimestampStrategy> = {
  encode(message: ProjectFile_TimestampStrategy, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ProjectFile_TimestampStrategy {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ProjectFileSource: MessageFns<ProjectFileSource> = {
  encode(message: ProjectFileSource, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    for (const v of message.tags) {
    ...
    for (const v of message.columns) {
      ProjectFileColumn.encode(v!, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ProjectFileSource {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ProjectFileColumn: MessageFns<ProjectFileColumn> = {
  encode(message: ProjectFileColumn, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    if (message.description !== undefined) {
    ...
    for (const v of message.tests) {
      ColumnTest.encode(v!, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ProjectFileColumn {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ColumnTest: MessageFns<ColumnTest> = {
  encode(message: ColumnTest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.type !== "") {
      writer.uint32(10).string(message.type);
    }
    Object.entries(message.info).forEach(([key, value]) => {
      ColumnTest_InfoEntry.encode({ key: key as any, value }, writer.uint32(18).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ColumnTest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ColumnTest_InfoEntry: MessageFns<ColumnTest_InfoEntry> = {
  encode(message: ColumnTest_InfoEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ColumnTest_InfoEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ModelTest: MessageFns<ModelTest> = {
  encode(message: ModelTest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.type !== "") {
      writer.uint32(10).string(message.type);
    }
    Object.entries(message.info).forEach(([key, value]) => {
      ModelTest_InfoEntry.encode({ key: key as any, value }, writer.uint32(18).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ModelTest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ModelTest_InfoEntry: MessageFns<ModelTest_InfoEntry> = {
  encode(message: ModelTest_InfoEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ModelTest_InfoEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
