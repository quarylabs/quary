 ...
 */
export class ConnectionConfig_ConnectionConfigClickHouse extends Message<ConnectionConfig_ConnectionConfigClickHouse> {
  /**
   * @generated from field: string database = 1;
   */
  database = "";

  constructor(data?: PartialMessage<ConnectionConfig_ConnectionConfigClickHouse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "quary.service.v1.ConnectionConfig.ConnectionConfigClickHouse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "database", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ConnectionConfig_ConnectionConfigClickHouse {
    return new ConnectionConfig_ConnectionConfigClickHouse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ConnectionConfig_ConnectionConfigClickHouse {
    return new ConnectionConfig_ConnectionConfigClickHouse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ConnectionConfig_ConnectionConfigClickHouse {
    return new ConnectionConfig_ConnectionConfigClickHouse().fromJsonString(jsonString, options);
  }

  static equals(a: ConnectionConfig_ConnectionConfigClickHouse | PlainMessage<ConnectionConfig_ConnectionConfigClickHouse> | undefined, b: ConnectionConfig_ConnectionConfigClickHouse | PlainMessage<ConnectionConfig_ConnectionConfigClickHouse> | undefined): boolean {
    return proto3.util.equals(ConnectionConfig_ConnectionConfigClickHouse, a, b);
  }
}
