...
impl serde::Serialize for CreateModelChartFileRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("quary.service.v1.CreateModelChartFileRequest", len)?;
        if !self.model_name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for CreateModelChartFileRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = CreateModelChartFileRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct quary.service.v1.CreateModelChartFileRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<CreateModelChartFileRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(CreateModelChartFileRequest {
                    model_name: model_name__.unwrap_or_default(),
                    config: config__,
                })
            }
        }
        deserializer.deserialize_struct("quary.service.v1.CreateModelChartFileRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CreateModelChartFileResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let mut len = 0;
        if !self.chart_file.is_empty() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("quary.service.v1.CreateModelChartFileResponse", len)?;
        if !self.chart_file.is_empty() {
            struct_ser.serialize_field("chartFile", &self.chart_file)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for CreateModelChartFileResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "chartFile" | "chart_file" => Ok(GeneratedField::ChartFile),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = CreateModelChartFileResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct quary.service.v1.CreateModelChartFileResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<CreateModelChartFileResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut chart_file__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::ChartFile => {
                            if chart_file__.is_some() {
                                return Err(serde::de::Error::duplicate_field("chartFile"));
                            }
                            chart_file__ = Some(map_.next_value()?);
                        }
                    }
                }
                Ok(CreateModelChartFileResponse {
                    chart_file: chart_file__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("quary.service.v1.CreateModelChartFileResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for DashboardChart {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("quary.service.v1.DashboardChart", len)?;
        if let Some(v) = self.chart.as_ref() {
            match v {
                dashboard_chart::Chart::Reference(v) => {
                    struct_ser.serialize_field("reference", v)?;
                }
            }
        }
...
impl<'de> serde::Deserialize<'de> for DashboardChart {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = DashboardChart;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct quary.service.v1.DashboardChart")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<DashboardChart, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut chart__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Reference => {
                            if chart__.is_some() {
                            ...
                            chart__ = map_.next_value::<::std::option::Option<_>>()?.map(dashboard_chart::Chart::Reference)
;
                        }
                    }
                }
        ...
        deserializer.deserialize_struct("quary.service.v1.DashboardChart", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DashboardChartReference {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("quary.service.v1.DashboardChartReference", len)?;
        if !self.reference.is_empty() {
...
impl<'de> serde::Deserialize<'de> for DashboardChartReference {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = DashboardChartReference;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct quary.service.v1.DashboardChartReference")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<DashboardChartReference, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(DashboardChartReference {
                    reference: reference__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("quary.service.v1.DashboardChartReference", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DashboardFile {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
...
impl<'de> serde::Deserialize<'de> for DashboardFile {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = DashboardFile;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct quary.service.v1.DashboardFile")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<DashboardFile, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut title__ = None;
        ...
        deserializer.deserialize_struct("quary.service.v1.DashboardFile", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DashboardItem {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("quary.service.v1.DashboardItem", len)?;
        if self.top_left_x != 0 {
            struct_ser.serialize_field("topLeftX", &self.top_left_x)?;
        }
        if self.top_left_y != 0 {
            struct_ser.serialize_field("topLeftY", &self.top_left_y)?;
        }
        if self.width != 0 {
        ...
        if let Some(v) = self.item.as_ref() {
            match v {
                dashboard_item::Item::Chart(v) => {
                    struct_ser.serialize_field("chart", v)?;
                }
            }
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for DashboardItem {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "topLeftX" | "top_left_x" => Ok(GeneratedField::TopLeftX),
                            "topLeftY" | "top_left_y" => Ok(GeneratedField::TopLeftY),
                            "width" => Ok(GeneratedField::Width),
                            "height" => Ok(GeneratedField::Height),
                            "chart" => Ok(GeneratedField::Chart),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = DashboardItem;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct quary.service.v1.DashboardItem")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<DashboardItem, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut top_left_x__ = None;
                let mut top_left_y__ = None;
                let mut width__ = None;
                let mut height__ = None;
                let mut item__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::TopLeftX => {
                            if top_left_x__.is_some() {
                                return Err(serde::de::Error::duplicate_field("topLeftX"));
                            }
                            top_left_x__ = 
                                Some(map_.next_value::<::pbjson::private::NumberDeserialize<_>>()?.0)
                            ;
                        }
                        GeneratedField::TopLeftY => {
                            if top_left_y__.is_some() {
                                return Err(serde::de::Error::duplicate_field("topLeftY"));
                            }
                            top_left_y__ = 
                                Some(map_.next_value::<::pbjson::private::NumberDeserialize<_>>()?.0)
                            ;
                        ...
                        GeneratedField::Chart => {
                            if item__.is_some() {
                                return Err(serde::de::Error::duplicate_field("chart"));
                            }
                            item__ = map_.next_value::<::std::option::Option<_>>()?.map(dashboard_item::Item::Chart)
;
                        }
                    }
                }
                Ok(DashboardItem {
                    top_left_x: top_left_x__.unwrap_or_default(),
                    top_left_y: top_left_y__.unwrap_or_default(),
        ...
        deserializer.deserialize_struct("quary.service.v1.DashboardItem", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DashboardRenderingItem {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("quary.service.v1.DashboardRenderingItem", len)?;
        if let Some(v) = self.item.as_ref() {
...
impl<'de> serde::Deserialize<'de> for DashboardRenderingItem {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = DashboardRenderingItem;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct quary.service.v1.DashboardRenderingItem")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<DashboardRenderingItem, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut item__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::Chart => {
                            ...
                            chart__ = map_.next_value()?;
                        }
                    }
                }
                Ok(DashboardRenderingItem {
                    item: item__,
        ...
        deserializer.deserialize_struct("quary.service.v1.DashboardRenderingItem", FIELDS, GeneratedVisitor)
    }
}
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.reason.as_ref() {
            match v {
                ...
                failed::Reason::FailedRunMessage(v) => {
                    struct_ser.serialize_field("failedRunMessage", v)?;
                }
            }
        }
        struct_ser.end()
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "failedRunMessage" | "failed_run_message" => Ok(GeneratedField::FailedRunMessage),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
...
;
                        ...
                        GeneratedField::FailedRunMessage => {
                            if reason__.is_some() {
                                return Err(serde::de::Error::duplicate_field("failedRunMessage"));
                            }
                            reason__ = map_.next_value::<::std::option::Option<_>>()?.map(failed::Reason::FailedRunMessage)
;
                        }
                    }
                }
...
impl serde::Serialize for FailedRunMessage {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("quary.service.v1.FailedRunMessage", len)?;
        if !self.message.is_empty() {
            struct_ser.serialize_field("message", &self.message)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for FailedRunMessage {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = FailedRunMessage;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct quary.service.v1.FailedRunMessage")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<FailedRunMessage, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut message__ = None;
        ...
        deserializer.deserialize_struct("quary.service.v1.FailedRunMessage", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for list_assets_request::AssetsToSkip {
        ...
        S: serde::Serializer,
    {
        let variant = match self {
            ...
            Self::ChartsAndDashboards => "ASSETS_TO_SKIP_CHARTS_AND_DASHBOARDS",
            Self::Dashboards => "ASSETS_TO_SKIP_DASHBOARDS",
        };
...
impl<'de> serde::Deserialize<'de> for list_assets_request::AssetsToSkip {
        ...
        D: serde::Deserializer<'de>,
    {
        const FIELDS: &[&str] = &[
            ...
            "ASSETS_TO_SKIP_NONE",
            "ASSETS_TO_SKIP_CHARTS_AND_DASHBOARDS",
            "ASSETS_TO_SKIP_DASHBOARDS",
        ];
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                ...
                E: serde::de::Error,
            {
                match value {
                    ...
                    "ASSETS_TO_SKIP_CHARTS_AND_DASHBOARDS" => Ok(list_assets_request::AssetsToSkip::ChartsAndDashboards),
                    "ASSETS_TO_SKIP_DASHBOARDS" => Ok(list_assets_request::AssetsToSkip::Dashboards),
...
impl serde::Serialize for Project {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.dashboards.is_empty() {
            struct_ser.serialize_field("dashboards", &self.dashboards)?;
        }
        if !self.project_files.is_empty() {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "dashboards" => Ok(GeneratedField::Dashboards),
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::Dashboards => {
                            if dashboards__.is_some() {
                                return Err(serde::de::Error::duplicate_field("dashboards"));
                            }
                            dashboards__ = Some(
                                map_.next_value::<std::collections::HashMap<_, _>>()?
                            );
                ...
                Ok(Project {
                    ...
                    dashboards: dashboards__.unwrap_or_default(),
...
impl serde::Serialize for ReturnEditModelPromptRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("quary.service.v1.ReturnEditModelPromptRequest", len)?;
        if !self.project_root.is_empty() {
            struct_ser.serialize_field("projectRoot", &self.project_root)?;
        }
        if !self.model_name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ReturnEditModelPromptRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ReturnEditModelPromptRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct quary.service.v1.ReturnEditModelPromptRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ReturnEditModelPromptRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut project_root__ = None;
                ...
                Ok(ReturnEditModelPromptRequest {
                    project_root: project_root__.unwrap_or_default(),
                    model_name: model_name__.unwrap_or_default(),
        ...
        deserializer.deserialize_struct("quary.service.v1.ReturnEditModelPromptRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ReturnEditModelPromptResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("quary.service.v1.ReturnEditModelPromptResponse", len)?;
        if !self.agent_prompt.is_empty() {
            struct_ser.serialize_field("agentPrompt", &self.agent_prompt)?;
        }
        if !self.user_prompt.is_empty() {
            struct_ser.serialize_field("userPrompt", &self.user_prompt)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for ReturnEditModelPromptResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "agentPrompt" | "agent_prompt" => Ok(GeneratedField::AgentPrompt),
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ReturnEditModelPromptResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct quary.service.v1.ReturnEditModelPromptResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ReturnEditModelPromptResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut agent_prompt__ = None;
                let mut user_prompt__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::AgentPrompt => {
                            if agent_prompt__.is_some() {
                                return Err(serde::de::Error::duplicate_field("agentPrompt"));
                            }
                            agent_prompt__ = Some(map_.next_value()?);
                        }
                        GeneratedField::UserPrompt => {
                            if user_prompt__.is_some() {
                                return Err(serde::de::Error::duplicate_field("userPrompt"));
                            }
                            user_prompt__ = Some(map_.next_value()?);
                        }
                    }
                }
                Ok(ReturnEditModelPromptResponse {
                    agent_prompt: agent_prompt__.unwrap_or_default(),
                    user_prompt: user_prompt__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("quary.service.v1.ReturnEditModelPromptResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ReturnExplainModelPromptRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("quary.service.v1.ReturnExplainModelPromptRequest", len)?;
        if !self.project_root.is_empty() {
            struct_ser.serialize_field("projectRoot", &self.project_root)?;
        }
        if !self.model_name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ReturnExplainModelPromptRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ReturnExplainModelPromptRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct quary.service.v1.ReturnExplainModelPromptRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ReturnExplainModelPromptRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut project_root__ = None;
                ...
                Ok(ReturnExplainModelPromptRequest {
                    project_root: project_root__.unwrap_or_default(),
                    model_name: model_name__.unwrap_or_default(),
                    user_prompt: user_prompt__.unwrap_or_default(),
                })
        ...
        deserializer.deserialize_struct("quary.service.v1.ReturnExplainModelPromptRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ReturnExplainModelPromptResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("quary.service.v1.ReturnExplainModelPromptResponse", len)?;
        if !self.agent_prompt.is_empty() {
            struct_ser.serialize_field("agentPrompt", &self.agent_prompt)?;
        }
        if !self.user_prompt.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ReturnExplainModelPromptResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ReturnExplainModelPromptResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct quary.service.v1.ReturnExplainModelPromptResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ReturnExplainModelPromptResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut agent_prompt__ = None;
        ...
        deserializer.deserialize_struct("quary.service.v1.ReturnExplainModelPromptResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for ReturnGenerateModelPromptRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("quary.service.v1.ReturnGenerateModelPromptRequest", len)?;
        if !self.project_root.is_empty() {
            struct_ser.serialize_field("projectRoot", &self.project_root)?;
        }
        if !self.prompt.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ReturnGenerateModelPromptRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ReturnGenerateModelPromptRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct quary.service.v1.ReturnGenerateModelPromptRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ReturnGenerateModelPromptRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut project_root__ = None;
                ...
                Ok(ReturnGenerateModelPromptRequest {
                    project_root: project_root__.unwrap_or_default(),
                    prompt: prompt__.unwrap_or_default(),
                    references: references__.unwrap_or_default(),
                })
        ...
        deserializer.deserialize_struct("quary.service.v1.ReturnGenerateModelPromptRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ReturnGenerateModelPromptResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("quary.service.v1.ReturnGenerateModelPromptResponse", len)?;
        if !self.agent_prompt.is_empty() {
            struct_ser.serialize_field("agentPrompt", &self.agent_prompt)?;
        }
        if !self.user_prompt.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ReturnGenerateModelPromptResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ReturnGenerateModelPromptResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct quary.service.v1.ReturnGenerateModelPromptResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ReturnGenerateModelPromptResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut agent_prompt__ = None;
        ...
        deserializer.deserialize_struct("quary.service.v1.ReturnGenerateModelPromptResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ReturnGenerateModelPromptToSearchForModelsRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("quary.service.v1.ReturnGenerateModelPromptToSearchForModelsRequest", len)?;
        if !self.project_root.is_empty() {
            struct_ser.serialize_field("projectRoot", &self.project_root)?;
        }
        if !self.prompt.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ReturnGenerateModelPromptToSearchForModelsRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ReturnGenerateModelPromptToSearchForModelsRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct quary.service.v1.ReturnGenerateModelPromptToSearchForModelsRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ReturnGenerateModelPromptToSearchForModelsRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut project_root__ = None;
                ...
                Ok(ReturnGenerateModelPromptToSearchForModelsRequest {
                    project_root: project_root__.unwrap_or_default(),
                    prompt: prompt__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("quary.service.v1.ReturnGenerateModelPromptToSearchForModelsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ReturnGenerateModelPromptToSearchForModelsResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("quary.service.v1.ReturnGenerateModelPromptToSearchForModelsResponse", len)?;
        if !self.agent_prompt.is_empty() {
            struct_ser.serialize_field("agentPrompt", &self.agent_prompt)?;
        }
        if !self.user_prompt.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ReturnGenerateModelPromptToSearchForModelsResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ReturnGenerateModelPromptToSearchForModelsResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct quary.service.v1.ReturnGenerateModelPromptToSearchForModelsResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ReturnGenerateModelPromptToSearchForModelsResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut agent_prompt__ = None;
        ...
        deserializer.deserialize_struct("quary.service.v1.ReturnGenerateModelPromptToSearchForModelsResponse", FIELDS, GeneratedVisitor)
    }
}
